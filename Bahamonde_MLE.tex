...
\begin{enumerate}
	...
	% Participation
	\item {\bf Participaci\'on (c\'atedra, Foro \texttt{uCampus} y ayudant\'ia)}: 10\%. \\
  ...
  \\
  \\
  Si tu participaci\'on sincr\'onica a clases/ayudant\'ia ha sido baja, paraticipa en el Foro \texttt{uCampus}.
	...
	Como ver\'as en el programa, la primera secci\'on es fil\'osofica y conceptual. En el control de lectura se medir\'a cu\'an bien pudiste comprender los conceptos. Si tienes dudas, no dudes en contactar al ayudante/profesor.
      ...
      \begin{itemize}
        \item[{\color{red}\Pointinghand}] Este control de lectura se realizar\'a de manera presencial.
      \end{itemize}


	\item {\bf \emph{Problem Sets}}: 50\% en total.\\
	...
	\item {\bf Un trabajo final obligatorio/no-eximible (15\%) y una presentaci\'on final (10\%, v\'ia Zoom)}: 35\% en total.\\

		En este curso, la actividad final es un trabajo final que tiene formato de trabajo grupal. Usando una base de datos que nosotros te daremos, t\'u y tu grupo deber\'an responder una serie de preguntas. El producto final (i.e. lo que debes entregar) consiste en un \emph{script} de \texttt{R}. La nota es grupal (i.e. todo el grupo recibir\'a la misma nota). {\bf Los grupos ser\'an de 2 personas}. La formacion del grupo es end\'ogena.
\\
\\
...
\begin{tabular}{ccc}
							...
							\hline
Participaci\'on (c\'atedra y ayudant\'ia) 	& 10\%       & 10\%                 \\
\hline
Problem Set \#1 							              & 15\% 		& 25\%                 \\
Problem Set \#2 							              & 15\% 		& 40\%                 \\
Problem Set \#3 							              & 10\% 		& 50\%                 \\
Problem Set \#4                             & 10\%    & 60\%                 \\
\hline
Control de lectura 							            & 15\% 		& 75\% \\
\hline
Trabajo final grupal                        & 15\%    & 90\% \\
            ...
            \item[6.] {\bf Incorporando el elemento \emph{tiempo}: \emph{fixed effects} y \emph{differences-in-differences}}.
                ...
                \item[$\circ$] {\bf Lecturas}: 
                  \begin{itemize} 
                    ...
                    \item[$\diamond$] Lectura recomendada: 
                      \begin{itemize}
                        \item[$\diamond$] Davide Cipullo and Marco Moglie (2021). \href{https://github.com/hbahamonde/MLE/raw/master/Readings/To_Vote_or_Not_to_Vote.pdf}{\emph{To Vote, or Not to Vote? Electoral Campaigns and the Spread of COVID-19}}. European Journal of Political Economy, \emph{forthcoming}.\phantom{\textcite{Cipullo2021}}
                      \end{itemize}
                  \end{itemize}
                \end{itemize}
            \end{itemize}

\item[{\color{red}\Pointinghand}] Entrega temario del \emph{Problem set} \#1. Tres d\'ias de plazo. Prep\'arate para responder preguntas tipo ensayo breve tambi\'en.
	...
	\item {\bf {\color{ForestGreen}\underline{Introducci\'on a MLE: Probabilidad y \emph{Likelihood}}}}
      ...
      \begin{itemize} 
        \item[11.] {\bf Control de lectura (presencial; en la sala clases).} 
          \begin{itemize}
            \item[{\color{red}\Pointinghand}] Entra todo lo visto hasta este momento hasta el \'ultimo control/\emph{problem set}.
          \end{itemize}


      \end{itemize}

%\item[{\color{red}\Pointinghand}] 
...
\item {\bf {\color{ForestGreen}\underline{\emph{Maximum Likelihood Estimation} para Outcomes Binarios: Los Modelos Logit y Probit}}}
      ...
      \end{itemize}
        ...
        \begin{itemize} 
        \item[14.] {\bf Inferencia e Interpretaci\'on.}
        \begin{itemize} 
...
\item[{\color{red}\Pointinghand}] Entrega temario del \emph{Problem set} \#2. Tres d\'ias de plazo.


\item {\bf{\color{ForestGreen}\underline{\emph{Maximum Likelihood Estimation} (MLE) para Modelos Generalizados (GLMs)}}}

       \begin{itemize} 
        \item[16.] {\bf \emph{Outcomes} Ordenados: Ordered Logit/Probit.}
        \begin{itemize} 
      ...
      \end{itemize}
       ...
       \begin{itemize} 
        \item[17.] {\bf \emph{Outcomes} Desordenados o ``Nominales'': Multi-Nomial Logit/Probit.}
        \begin{itemize} 
          \item[$\circ$] Derivaci\'on. Estimaci\'on. Interpretaci\'on.
          \item[$\circ$] {\bf Lecturas}: 
            \begin{itemize} 
...
\item[{\color{red}\Pointinghand}] Entrega temario del \emph{Problem set} \#3. Tres d\'ias de plazo.



       \begin{itemize} 
        \item[18.] {\bf \emph{Outcomes} de Cuentas: Modelos Poisson y Negative-Binomial.}
        \begin{itemize} 
          \item[$\circ$] Derivaci\'on. Estimaci\'on. Interpretaci\'on.
          \item[$\circ$] {\bf Lecturas}: 
            \begin{itemize} 
...
\item {\bf {\color{ForestGreen}\underline{Extensiones}}}
      ...
      \begin{itemize} 
        \item[19.] {\bf \emph{Outcomes} Poco Frecuentes: Zero-Inflated (Poisson y Negative-Binomial) y Rare Event Logistic.}
        \begin{itemize} 
          \item[$\circ$] Derivaci\'on. Estimaci\'on. Interpretaci\'on.
          \item[$\circ$] {\bf Lecturas}: 
            \begin{itemize} 
...
\item[{\color{red}\Pointinghand}] Entrega temario del \emph{Problem set} \#4. Tres d\'ias de plazo.


     \begin{itemize} 
        \item[20.] {\bf \emph{Outcomes} Censurados/Truncados: Tobit Models.}
        \begin{itemize} 
          \item[$\circ$] Derivaci\'on. Estimaci\'on. Interpretaci\'on.
          \item[$\circ$] {\bf Lecturas}: 
            \begin{itemize} 
      ...
      \end{itemize}
       ...
       \begin{itemize} 
        \item[21.] {\bf MLE y Causal Inference: Matching, \emph{Covariate Balance}, y el \emph{Propensity Score}.}
        \begin{itemize} 
          \item[$\circ$] Derivaci\'on. Estimaci\'on. Interpretaci\'on.
          \item[$\circ$] {\bf Lecturas}: 
            \begin{itemize} 
...
\item {\bf {\color{ForestGreen}\underline{Sesiones Guiadas de Trabajo y Presentaciones Finales}}}
     ...
     \begin{itemize} 
        \item[22.] {\bf Sesi\'on Guiada de Trabajo \#1}
        \begin{itemize} 
      ...
      \end{itemize}
       ...
       \begin{itemize} 
        \item[23.] {\bf Sesi\'on Guiada de Trabajo \#2}
        \begin{itemize} 
          \item[$\circ$] Oportunidad para trabajar en grupo bajo la supervisi\'on del profesor/ayudante. Llevar dudas.
        \end{itemize}
      \end{itemize}
       ...
       \begin{itemize} 
        \item[24.] {\bf Sesi\'on Guiada de Trabajo \#3}
        \begin{itemize} 
          \item[$\circ$] Oportunidad para trabajar en grupo bajo la supervisi\'on del profesor/ayudante. Llevar dudas.
        \end{itemize}
      \end{itemize}
      ...
      \begin{itemize} 
        \item[25.] {\bf Presentaciones Finales}
        \begin{itemize} 
