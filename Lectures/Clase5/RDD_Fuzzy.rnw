...
<<datos:1, echo = TRUE, warning = FALSE, message = F, fig.align='center', fig.width=6, fig.height=3,dpi=1000,cache=F, include = TRUE>>=
...
<<datos:2, echo = TRUE, warning = FALSE, message = F, fig.align='center', fig.width=6, fig.height=3,dpi=1000,cache=F, include = TRUE>>=
table(d$z)
@

Metamos ese vector de probabilidades en una funci\'on para convertirlos en 0's y 1's

<<datos:3, echo = TRUE, warning = FALSE, message = F, fig.align='center', fig.width=6, fig.height=3,dpi=1000,cache=F, include = TRUE>>=
d$z <- sapply(X = d$z, FUN = function(x) rbinom(1, 1, prob = x)) # funcion
@

Ve\'amos c\'omo qued\'o:

<<datos:4, echo = TRUE, warning = FALSE, message = F, fig.align='center', fig.width=6, fig.height=3,dpi=1000,cache=F, include = TRUE>>=
table(d$z)
@

Ahora fabriquemos el efecto de $z$ en $y$, y digamos que es $2$ (combinaci\'on lineal).

<<datos:5, echo = TRUE, warning = FALSE, message = F, fig.align='center', fig.width=6, fig.height=3,dpi=1000,cache=F, include = TRUE>>=
d$y <- d$y + d$z * 2
@

Ahora grafiqu\'emos

<<datos:6, echo = TRUE, warning = FALSE, message = F, fig.align='center', fig.width=6, fig.height=6,dpi=1000,cache=F, include = TRUE>>=
plot(d$x, d$y,
...
<<datos:7, echo = TRUE, warning = FALSE, message = F, fig.align='center', fig.width=6, fig.height=6,dpi=1000,cache=F, include = TRUE>>=
# Estimar Fuzzy RDD
p_load(rddtools)
