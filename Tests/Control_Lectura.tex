...
\begin{enumerate}
 \item \textcite[16]{King1998} explica que ``$M$ is treated as given is a problem because uncertainty in inference lies with the model, not the data.'' Qu\'e quiere decir?
\end{enumerate}
